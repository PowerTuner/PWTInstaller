...
namespace PWTI {
    ...
    protected:
        ...
        QHBoxLayout *buttonsLyt = nullptr;
        QPushButton *prevBtn = nullptr;
        QPushButton *nextBtn = nullptr;
        QPushButton *exitBtn = nullptr;

    public:
        explicit Page(const QSharedPointer<installData> &installData);

        void setNavigation(Page *prev, Page *next, bool hasExit);

    protected slots:
        virtual void onPrevBtnClicked();
        virtual void onNextBtnClicked();
        virtual void onExitBtnClicked() const;
    };
}
