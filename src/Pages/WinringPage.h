...
namespace PWTI {
    class WinringPage final: public Page {
    public:
        explicit WinringPage(const QSharedPointer<installData> &installData);

    private slots:
        void onAgreeStateChanged(Qt::CheckState state) const;
